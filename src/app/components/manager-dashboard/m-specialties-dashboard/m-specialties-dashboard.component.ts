...
@Component({
  selector: 'app-m-specialties-dashboard',
  templateUrl: './m-specialties-dashboard.component.html',
  styleUrls: ['./m-specialties-dashboard.component.css']
})
export class MSpecialtiesDashboardComponent implements OnInit {
