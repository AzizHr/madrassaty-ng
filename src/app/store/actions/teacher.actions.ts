...
export const loadTeachersBySchoolIdSuccess = createAction("[Teacher] Load Teachers By School Id Success", props<{ teacherPage: Page<UserResponse> }>());
...
export const loadTeachersBySchoolIdWithNoPaginationSuccess = createAction("[Teacher] Load Teachers By School Id With No Pagination Success", props<{ teacherPage: Page<UserResponse> }>());
...
export const loadTeachersByClassIdSuccess = createAction("[Teacher] Load Teachers By Class Id Success", props<{ teacherPage: Page<UserResponse> }>());
