...
export const loadStudentsBySchoolIdSuccess = createAction("[Student] Load Students By School Id Success", props<{ studentPage: Page<UserResponse> }>());
...
export const loadStudentsBySchoolIdWithNoPaginationSuccess = createAction("[Student] Load Students By School Id With No Pagination Success", props<{ studentPage: Page<UserResponse> }>());
...
export const loadStudentsByClassIdSuccess = createAction("[Student] Load Students By Class Id Success", props<{ studentPage: Page<UserResponse> }>());
...
export const loadStudentsByClassIdWithNoPaginationSuccess = createAction("[Student] Load Students By Class Id With No Pagination Success", props<{ studentPage: Page<UserResponse> }>());
