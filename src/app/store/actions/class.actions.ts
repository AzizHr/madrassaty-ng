...
export const loadClassesBySchoolId = createAction("[Class] Load Classes By School Id", props<{ schoolId: number, page: number, size: number }>());
...
export const loadClassesBySchoolIdWithNoPagination = createAction("[Class] Load Classes By School Id With No Pagination", props<{ schoolId: number }>());
...
export const loadClassesByTeacherId = createAction("[Class] Load Classes By Teacher Id", props<{ teacherId: number, page: number, size: number }>());
...
export const loadClassesByTeacherIdWithNoPagination = createAction("[Class] Load Classes By Teacher Id With No Pagination", props<{ teacherId: number }>());
