...
export const loadSpecialtiesBySchoolId = createAction("[Specialty] Load Specialties By School Id", props<{ schoolId: string, page: number, size: number }>());
...
export const loadSpecialtiesBySchoolIdWithNoPagination = createAction("[Specialty] Load Specialties By School Id With No Pagination", props<{ schoolId: string }>());
